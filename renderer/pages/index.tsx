  ...
  const tools = [
    ...
    },
    {
      ...
      icon: () => (
        ...
        >
          <path
            d="M13.166 13.1667L16.4993 16.5"
            stroke="currentColor"
            strokeWidth="1.5"
            strokeLinecap="round"
          ...
          />
          <path
            d="M7.33203 7.33337L11.4982 17.3334L12.9773 12.9786L17.332 11.4995L7.33203 7.33337Z"
            stroke="currentColor"
            strokeWidth="1.5"
            strokeLinecap="round"
            strokeLinejoin="round"
  ...
  const RenderToolbar = () => {
    return (
      <>
        ...
        {/* <div id="arrow" className="toolbar-icon">
          <svg
            width="20"
            height="20"
            viewBox="0 0 20 20"
  ...
  return (
    <>
      <div id="toolbar">
        ...
        <RenderToolbar />
        <div className="separator"></div>
        <input type={"range"} max="10" className="slider" />
        <div className="separator"></div>
